...
class mypanel extends JPanel implements Runnable{
    ...
    public void fontpaint(Graphics g){
        ...
        g.drawString("天",350,100);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("猪猪",100,185);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("冷",450,100);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("了",350,250);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("等",450,250);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("回",100,370);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("去",250,370);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("给",400,370);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("你",550,370);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("暖",700,370);
        a=getColor();
        g.setColor(new Color(a[0],a[1],a[2]));
        g.drawString("手",400,500);
        a=getColor();
        /*
        g.setColor(new Color(a[0],a[1],a[2]));
